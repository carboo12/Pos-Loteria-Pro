...
const qrCode = (text: string): number[] => {
  ...
  // 2. Set module size (size 10 — was 6, increased for larger modules on 48mm paper)
  cmds.push(0x1D, 0x28, 0x6B, 0x03, 0x00, 0x31, 0x43, 0x0A);
  // 3. Set error correction level Q (0x32 = 25% recovery — was L/0x30 at 7%, insufficient for wrinkled thermal paper)
  cmds.push(0x1D, 0x28, 0x6B, 0x03, 0x00, 0x31, 0x45, 0x32);
  // 4. Store data

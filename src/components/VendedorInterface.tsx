...
export default function VendedorInterface({
  ...
  return (
    <div id="vendedor-container" className="flex flex-col bg-[#F3F4F6] h-full w-full overflow-hidden">
      ...
      <div className="bg-white border-t border-gray-300 py-1 px-4 flex justify-between items-center z-10">
        ...
        >
          <Gamepad2 className={`w-6 h-6 stroke-[2.5] ${activeTab === "venta" ? "text-[#1E3A8A]" : ""}`} />
          <span className="text-[10px] font-display font-black uppercase tracking-wider mt-0.5">Venta</span>
        </button>
        ...
        >
          <History className={`w-6 h-6 stroke-[2.5] ${activeTab === "historial" ? "text-[#1E3A8A]" : ""}`} />
          <span className="text-[10px] font-display font-black uppercase tracking-wider mt-0.5">Anulaciones</span>
        </button>
